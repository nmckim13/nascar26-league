-- Every normalized result must point to the season seat that produced it.
-- The team and car snapshot remains on the result so later transfers cannot
-- rewrite historical team totals.
